...
\section{Technical Skills}
    \resumeSubHeadingListStart % {\textst{Sth}}
        \resumeSubheading
            ...
            {{\textst{HTML5/CSS3}}, Javascript {\textst{(TS/ES6)}}, React.js {\textst{(Context API/Redux)}}, {\textst{Next.js}}, {\textst{Vue.js}}, {\textst{Angular.js}}}{}
        \resumeSubheading
            {Backend}{Intermediate} % Laravel, Spring, Node.js
            {PHP {\textst{(Laravel)}}, Java {\textst{(Spring Boot/MVC)}}, C\# (ASP.NET MVC/Web API, .NET Core, EF Core), {\textst{Node.js}}}{}
        \resumeSubheading
