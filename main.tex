...
\section{Technical Skills}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            {Backend}{Good} % Laravel, Node.js, Spring
            {PHP, Java, C\# (ASP.NET MVC/Web API, .NET Core, EF Core)}{}
        \resumeSubheading
            {Databases}{Good} % NoSQL, Firebase, Elastic Search, MongoDB, Queue and Caching Strategies, RabbitMQ, Redis
